		...
		<div className="mx-auto max-w-3xl px-4 sm:px-6 md:max-w-5xl">
			<div className="mx-auto  px-4 py-6 md:py-8 flex flex-col text-center gap-4 text-neutral-900 md:flex-row md:justify-between">
				<div className="flex flex-row items-center justify-center space-x-1 text-neutral-100 text-lg">
					© {currentYear} Ali Sleiman
				</div>
				
				<div className="flex flex-row items-center justify-center space-x-2 mb-1">
					<a
						href="https://github.com/AliSleiman0/"
						rel="noreferrer"
						target="_blank"
					>
						<AiOutlineGithub
					...
					<a
						href="https://www.linkedin.com/in/AliSleiman11/"
						rel="noreferrer"
						target="_blank"
					>
						<AiOutlineLinkedin
					...
					<a
						href="https://www.instagram.com/alisleiman0?igsh=MXR6bmR1anR3ZTVucw=="
						rel="noreferrer"
						target="_blank"
					>
						<AiOutlineInstagram
