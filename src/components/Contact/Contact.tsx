...
const email = "sleimana181@gmail.com";
...
function Contact() {
	...
	const onSubmitForm = async (event: FormEvent<HTMLFormElement>) => {
		...
		formData.append("access_key", "35bbc322-60d8-4bdb-886b-8f0107dac99a");
				...
				<div className="flex flex-col items-center md:flex-row md:items-start md:px-10">
					<div className="md:w-2/5 mb-8 text-center md:text-left md:pr-10 md:mr-4">
						...
						<p>
							...
							<Link
								className="hover:text-secondary transition-colors"
								to={`https://www.linkedin.com/in/AliSleiman11/`}
							>
								<u>Linkedin</u>
							</Link>
						</p>
					...
					<div className="md:w-3/5 w-full">
						<form onSubmit={onSubmitForm} className="flex flex-col gap-2">
							<input
								type="hidden"
								name="subject"
								value="New Submission From Contact Form. Ali Sleiman Portfolio"
							></input>
